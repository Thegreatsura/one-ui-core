...
<CodeBlock
  ...
  preview={
    <Column fillWidth gap="4">
      <Input height="xs" label="Extra small input" />
      <Input height="s" label="Small input" />
      <Input height="m" label="Medium input" />
      <Input height="l" label="Large input" />
      <Input height="xl" label="Extra large input" />
    </Column>
  }
  codes={[
    {
