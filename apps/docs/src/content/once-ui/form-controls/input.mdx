...
<CodeBlock
  ...
  preview={
    <Column fillWidth gap="16">
      <Input id="size-xs" placeholder="Extra Small" height="xs" />
      <Input id="size-s" placeholder="Small" height="s" />
      <Input id="size-m" placeholder="Medium" height="m" />
      <Input id="size-l" placeholder="Large" height="l" />
      <Input id="size-xl" placeholder="Extra Large" height="xl" />
    </Column>
  }
  codes={[
    {
