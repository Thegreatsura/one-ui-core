...
<Feedback marginTop="16" marginBottom="24" title="Peer dependency" description="CodeBlock requires prismjs for syntax highlighting. Install it with: npm install prismjs" />
