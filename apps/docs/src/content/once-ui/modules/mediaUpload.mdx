...
<Feedback marginTop="16" marginBottom="24" title="Peer dependency" description="MediaUpload requires compressorjs for image compression. Install it with: npm install compressorjs" />
